...
# this function enables us to choose the network to deploy our contract on:
# testnets/ mainnet/ local_blockchain_environment
...
def deploy_mocks():
    ...
    mock_price_feed = MockV3Aggregator.deploy(18,1 * 10 ** 18, {"from": account})
